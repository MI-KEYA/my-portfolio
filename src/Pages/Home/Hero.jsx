...
const Hero = () => {
    return (
        <div className='w-4/5 mx-auto lg:flex  items-center justify-around gap-10 mt-20 border-2 rounded-2xl py-5'>
            <div className='lg:w-2/5 lg:mx-auto pl-3 lg:pl-10 '>
            ...
            <div className='lg:w-3/5 pt-5 lg:pt-0 px-5'>
                ...
                <p className='mt-4 font-semibold text-gray-500'>Passionate frontend developer crafting clean, responsive user interfaces using React, Tailwind,<br />
